...
spec :: Spec
spec = do
  describe "applying hotPathSearch to randomTree" $ do
  ...
  describe "applying depthFirstSearch to randomTree" $ do
    it "find 4 as even" $
  ...
  describe "applying breadthFirstSearch to randomTree" $ do
    it "find 1" $
  ...
  describe "applying dovetailingSearch to randomTree" $ do
    it "find 4 as even" $
